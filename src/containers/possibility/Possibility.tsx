...
const Possibility = () => (
  <div className="productX__possibility section__padding" id="possibility">
    <div className="productX__possibility-image">
      <img src={possibilityImage} alt="possibility" />
    </div>
    <div className="productX__possibility-content">
